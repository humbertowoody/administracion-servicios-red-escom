...
def scan_by_interface(interface_name="enp0s3",user="admin",password="admin01",secret="12345678"):
    ...
    for k,v in net_router.items():
        for w,x in v.items():
            host_n2={"hostname":k,"ip":x.split("/")[0]}
        conexiones_r2.append(host_n2)
    ...
    # Posicion 4 devuelve el arreglo de los host y sus direcciones ip
    return [conexiones_r, arr_conexiones, net_router, responde, conexiones_r2]
